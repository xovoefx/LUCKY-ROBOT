...
PM_START_TEXT = """
*ʜᴇʏ* {}, [🥀](https://telegra.ph/file/e8b69f51092362f9a4e0c.jpg)
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="ᴅᴇᴠᴇʟᴏᴩᴇʀ", url=f"tg://user?id=1960744931"
                        ),
                        InlineKeyboardButton(
                            text="sᴏᴜʀᴄᴇ",
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                    InlineKeyboardButton(text="🍹 ᴀᴅᴍɪɴ 🍹", callback_data="Music_back"),
                    InlineKeyboardButton(text="🍬 ᴘʟᴀʏ 🍬", callback_data="Music_basic"),
                 ]
                ]
            ),
        )
